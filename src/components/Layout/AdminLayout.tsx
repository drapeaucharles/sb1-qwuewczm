...
import { Home, PlusCircle, List, Settings, LogOut, User, MessageSquare } from 'lucide-react';
...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Add Restaurant', href: '/admin/create', icon: PlusCircle },
    { name: 'All Restaurants', href: '/admin/restaurants', icon: List },
        ...
        <div className="w-64 bg-white shadow-xl border-r border-slate-200">
          <div className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-800">RestaurantAI</h1>
